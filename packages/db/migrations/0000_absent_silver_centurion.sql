...
CREATE TYPE "public"."verification_token_purpose" AS ENUM('email_verify', 'password_reset');--> statement-breakpoint
...
CREATE TYPE "public"."quiz_question_type" AS ENUM('multiple_choice', 'true_false', 'multi_select');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "course_reviews" (
	...
	"body" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "course_reviews_rating_range_check" CHECK ("course_reviews"."rating" between 1 and 5)
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "quiz_questions" (
	...
	"question_type" "quiz_question_type" DEFAULT 'multiple_choice' NOT NULL,
...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "course_certificates_user_course_unique_idx" ON "course_certificates" USING btree ("user_id","course_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "course_certificates_user_id_idx" ON "course_certificates" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "course_certificates_course_id_idx" ON "course_certificates" USING btree ("course_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "course_reviews_user_course_unique_idx" ON "course_reviews" USING btree ("user_id","course_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "course_reviews_course_id_idx" ON "course_reviews" USING btree ("course_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "enrollments_user_course_unique_idx" ON "enrollments" USING btree ("user_id","course_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "lesson_progress_user_lesson_unique_idx" ON "lesson_progress" USING btree ("user_id","lesson_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lesson_progress_user_id_idx" ON "lesson_progress" USING btree ("user_id");--> statement-breakpoint
