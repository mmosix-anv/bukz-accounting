...
export async function getSalaryBenchmark(params: { role?: string; location?: string; experienceLevel?: string }) {
  ...
  return { percentile25: p(0.25), median: p(0.5), percentile75: p(0.75), sampleSize: results.length };
}
